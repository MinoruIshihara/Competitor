...
void draw() {
  ...
  text(     "RGB = ",  15 + textPosX,  15 + textPosY);
  text(     RGBText,  15 + textPosX +      100,  15 + textPosY);
  
  text(   "Color = ",  15 + textPosX, 300 + textPosY);
  text(   colorText,  15 + textPosX + DataPos, 300 + textPosY);
  
  text(     "Time: ",  15 + textPosX, 615 + textPosY);
  text(    TimeText,  15 + textPosX + DataPos, 615 + textPosY);
  
  text(      "FPS: ",  15 + textPosX, 615 + textPosY + 40);
  text(    fpsText,  15 + textPosX + DataPos, 615 + textPosY + 40);

  text(    "COM/s: ",  15 + textPosX, 615 + textPosY + 80);
  text(    dpsText,  15 + textPosX + DataPos, 615 + textPosY + 80);

  text("Distance = ", 410 + textPosX,  15 + textPosY);
  text(DistanceText, 410 + textPosX + DataPos,  15 + textPosY);                
  
  text("Position = ", 410 + textPosX, 415 + textPosY);
  text(PositionText, 410 + textPosX + DataPos, 415 + textPosY);
  
  text(   "Angle = ", 805 + textPosX,  15 + textPosY);
  text(   AngleText, 805 + textPosX + DataPos,  15 + textPosY);
  ...
  strokeWeight(0);
  fill(210, 20, 20);
  ellipse(410 + xyGraphX + xyGraphSize / 2 + map(robotPosX, 0, 510, 0, xyGraphSize / 2),
          415 + xyGraphY + xyGraphSize / 2 - map(robotPosY, 0, 510, 0, xyGraphSize / 2),
          15,
          15);
...
void mapping(){
  ...
  distance = map(distance, 0, 255, 0.0, 32.0);
  angle = map(angle, 0, 255, -PI, PI);
  robotPosX = (int)map(robotPosX, 0, 255, -255, 255);
  robotPosY = (int)map(robotPosY, 0, 255, -255, 255);
}
